...
public class Simulacion {
	...
	public void estadisticasClientes() {
		for (int i = 0; i < numPeriodos; i++) {
			Usuario.mensajeConsola(" Periodo " + periodos[i].getHoraInicio() + " - " + periodos[i].getHoraTermino());
			Usuario.mensajeConsola("Numero total de pacientes: " + periodos[i].getTotalPacientes());
			Usuario.mensajeConsola("Numero pacientes Urgencia Alta: " + periodos[i].getPacientesTipo(0));
			Usuario.mensajeConsola("Numero pacientes Urgencia Media: " + periodos[i].getPacientesTipo(1));
			Usuario.mensajeConsola("Numero pacientes Urgencia Baja: " + periodos[i].getPacientesTipo(2));
			Usuario.mensajeConsola("Numero pacientes traumatologicos: " + periodos[i].getPacientesTrauma());
			Usuario.mensajeConsola("-------------------");
		}
		Usuario.mensajeConsola("Tiempo espera promedio pacientes no traumatologicos: " + colaNoTrauma.esperaPromedio());
		Usuario.mensajeConsola("Tiempo espera promedio pacientes traumatologicos: " + colaTrauma.esperaPromedio());
		...
		Usuario.mensajeConsola("Tiempo espera promedio todos : " + (colaTrauma.esperaPromedio() * percAnalogos + colaNoTrauma.esperaPromedio() * percDigitales));
	}
